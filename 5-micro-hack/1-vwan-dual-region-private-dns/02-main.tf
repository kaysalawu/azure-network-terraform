...
locals {
  ...
  branch3_tags = { "lab" = "mH51_Vwan_Dns", "nodeType" = "branch" }
  spoke1_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "spoke" }
  spoke2_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "spoke" }
  spoke3_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "float" }
  spoke4_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "spoke" }
  spoke5_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "spoke" }
  spoke6_tags  = { "lab" = "mH51_Vwan_Dns", "nodeType" = "float" }
}
