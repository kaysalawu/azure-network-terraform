...
OpnType=${OpnType}
TrustedSubnetAddressPrefix=${TrustedSubnetAddressPrefix}
WindowsVmSubnetAddressPrefix=${WindowsVmSubnetAddressPrefix}
publicIPAddress=${publicIPAddress}
opnSenseSecondarytrustedNicIP=${opnSenseSecondarytrustedNicIP}
...
if [ "$OpnType" = "Primary" ]; then
    ...
    sed -i "" "s_zzz.zzz.zzz.zzz_$WindowsVmSubnetAddressPrefix_" config.xml
