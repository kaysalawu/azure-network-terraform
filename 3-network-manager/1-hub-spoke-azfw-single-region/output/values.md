...
| - | -  |
| VM_IP   | 10.10.0.5   |
| VM_NAME   | Ne31-branch1-vm   |
| VNET_NAME   | Ne31-branch1-vnet   |
...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | ne31-spoke3-b8b6-app.azurewebsites.net   |
...
| - | -  |
| VM_IP   | 10.11.0.5   |
| VM_NAME   | Ne31-hub1-vm   |
| VNET_NAME   | Ne31-hub1-vnet   |
...
| - | -  |
| VM_IP   | 10.1.0.5   |
| VM_NAME   | Ne31-spoke1-vm   |
| VNET_NAME   | Ne31-spoke1-vnet   |
...
| - | -  |
| VM_IP   | 10.2.0.5   |
| VM_NAME   | Ne31-spoke2-vm   |
| VNET_NAME   | Ne31-spoke2-vnet   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | ne31-spoke3-b8b6-app.azurewebsites.net   |
| *Subnets*|        |
...
| - | -  |
| VM_IP   | 10.3.0.5   |
| VM_NAME   | Ne31-spoke3-vm   |
| VNET_NAME   | Ne31-spoke3-vnet   |
