...
match address local 10.10.1.9
match identity remote address 20.81.21.0 255.255.255.255
match identity remote address 4.255.71.118 255.255.255.255
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.255.71.118
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
