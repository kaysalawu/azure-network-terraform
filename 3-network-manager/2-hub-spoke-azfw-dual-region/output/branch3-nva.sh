...
peer 172.171.168.178
address 172.171.168.178
pre-shared-key changeme
peer 172.171.171.220
address 172.171.171.220
pre-shared-key changeme
peer 10.10.1.9
address 10.10.1.9
pre-shared-key changeme
...
match address local 10.30.1.9
match identity remote address 172.171.168.178 255.255.255.255
match identity remote address 172.171.171.220 255.255.255.255
...
tunnel destination 172.171.168.178
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 172.171.171.220
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip route 10.22.10.5 255.255.255.255 Tunnel0
ip route 10.22.10.4 255.255.255.255 Tunnel1
