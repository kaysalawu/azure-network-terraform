...
match address local 10.30.1.9
match identity remote address 20.54.68.244 255.255.255.255
match identity remote address 20.54.69.0 255.255.255.255
...
tunnel destination 20.54.68.244
