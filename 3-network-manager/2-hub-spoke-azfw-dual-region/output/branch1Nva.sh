...
conn Tunnel0
    left=10.10.1.9
    leftid=52.178.156.42
    right=172.205.11.3
    rightid=172.205.11.3
    auto=start
    mark=100
...
10.10.1.9 172.205.11.3 : PSK "changeme"
10.10.1.9 172.205.11.2 : PSK "changeme"
10.10.1.9 52.191.71.150 : PSK "changeme"
