...
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vwan23-spoke3-1d2a-app.azurewebsites.net) - vwan23-spoke3-1d2a-app.azurewebsites.net"
EOF
