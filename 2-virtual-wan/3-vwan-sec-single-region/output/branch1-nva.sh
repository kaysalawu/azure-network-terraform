...
peer 20.241.152.254
address 20.241.152.254
pre-shared-key changeme
peer 20.241.153.8
address 20.241.153.8
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.241.152.254 255.255.255.255
match identity remote address 20.241.153.8 255.255.255.255
...
tunnel destination 20.241.152.254
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.241.153.8
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
