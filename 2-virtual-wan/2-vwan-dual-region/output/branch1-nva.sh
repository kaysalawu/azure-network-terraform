...
peer 20.73.221.176
address 20.73.221.176
pre-shared-key changeme
peer 20.73.218.11
address 20.73.218.11
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.73.221.176 255.255.255.255
match identity remote address 20.73.218.11 255.255.255.255
...
tunnel destination 20.73.221.176
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.73.218.11
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
