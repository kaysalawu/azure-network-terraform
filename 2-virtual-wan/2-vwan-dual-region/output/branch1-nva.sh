...
match address local 10.10.1.9
match identity remote address 20.102.9.90 255.255.255.255
match identity remote address 20.102.11.22 255.255.255.255
...
tunnel destination 20.102.9.90
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.102.11.22
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
