...
match address local 10.10.1.9
match identity remote address 20.71.70.73 255.255.255.255
match identity remote address 20.71.70.84 255.255.255.255
...
tunnel destination 20.71.70.73
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.71.70.84
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
