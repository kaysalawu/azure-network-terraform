...
match address local 10.10.1.9
match identity remote address 20.23.172.227 255.255.255.255
match identity remote address 20.82.74.88 255.255.255.255
...
tunnel destination 20.23.172.227
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.82.74.88
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
