...
conn vti0
    left=10.30.1.9
    leftid=52.179.255.87
    right=20.94.111.229
    rightid=20.94.111.229
    auto=start
    mark=100
...
10.30.1.9 20.94.111.229 : PSK "changeme"
10.30.1.9 20.94.111.234 : PSK "changeme"
10.30.1.9 40.85.121.99 : PSK "changeme"
