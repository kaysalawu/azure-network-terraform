...
conn Tunnel0
    left=10.30.1.9
    leftid=172.203.146.71
    right=4.156.227.58
    rightid=4.156.227.58
    auto=start
    mark=100
...
10.30.1.9 4.156.227.58 : PSK "changeme"
10.30.1.9 4.156.227.56 : PSK "changeme"
10.30.1.9 13.79.94.184 : PSK "changeme"
