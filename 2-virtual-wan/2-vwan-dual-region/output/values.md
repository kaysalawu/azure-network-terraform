...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | vwan22-spoke3-f47a-app.azurewebsites.net   |
...
| SPOKE6_APP_SVC_ENDPOINT_DNS   | vwan22-spoke6-f47a-app.azurewebsites.net   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | vwan22-spoke3-f47a-app.azurewebsites.net   |
| *Subnets*|        |
