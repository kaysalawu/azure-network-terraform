...
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vwan22-spoke3-f47a-app.azurewebsites.net) - vwan22-spoke3-f47a-app.azurewebsites.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vwan22-spoke6-f47a-app.azurewebsites.net) - vwan22-spoke6-f47a-app.azurewebsites.net"
EOF
