...
conn vti0
    left=10.10.1.9
    leftid=13.69.183.75
    right=135.236.178.180
    rightid=135.236.178.180
    auto=start
    mark=100
...
conn vti1
    left=10.10.1.9
    leftid=13.69.183.75
    right=135.236.178.235
    rightid=135.236.178.235
    auto=start
    mark=101
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn vti2
...
10.10.1.9 135.236.178.180 : PSK "changeme"
10.10.1.9 135.236.178.235 : PSK "changeme"
