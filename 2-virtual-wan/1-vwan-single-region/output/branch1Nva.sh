...
conn Tunnel0
    left=10.10.1.9
    leftid=13.79.85.176
    right=135.236.128.104
    rightid=135.236.128.104
    auto=start
    mark=100
...
conn Tunnel1
    left=10.10.1.9
    leftid=13.79.85.176
    right=135.236.128.105
    rightid=135.236.128.105
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
...
10.10.1.9 135.236.128.104 : PSK "changeme"
10.10.1.9 135.236.128.105 : PSK "changeme"
