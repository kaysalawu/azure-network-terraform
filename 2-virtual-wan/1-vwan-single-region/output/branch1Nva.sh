...
match address local 10.10.1.9
match identity remote address 4.209.243.21 255.255.255.255
match identity remote address 4.209.243.2 255.255.255.255
...
tunnel destination 4.209.243.21
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.209.243.2
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
