...
peer 20.76.108.78
address 20.76.108.78
pre-shared-key changeme
peer 20.76.107.34
address 20.76.107.34
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.76.108.78 255.255.255.255
match identity remote address 20.76.107.34 255.255.255.255
...
tunnel destination 20.76.108.78
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.76.107.34
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
