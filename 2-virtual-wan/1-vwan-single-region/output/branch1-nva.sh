...
peer 4.231.145.95
address 4.231.145.95
pre-shared-key changeme
peer 4.231.145.148
address 4.231.145.148
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 4.231.145.95 255.255.255.255
match identity remote address 4.231.145.148 255.255.255.255
...
tunnel destination 4.231.145.95
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.231.145.148
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
