...
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vwan21-spoke3-11fb-app.azurewebsites.net) - vwan21-spoke3-11fb-app.azurewebsites.net"
EOF
