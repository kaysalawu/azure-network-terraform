...
peer 4.209.241.95
address 4.209.241.95
pre-shared-key changeme
peer 4.209.241.121
address 4.209.241.121
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 4.209.241.95 255.255.255.255
match identity remote address 4.209.241.121 255.255.255.255
...
tunnel destination 4.209.241.95
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.209.241.121
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip route 192.168.11.14 255.255.255.255 Tunnel0
ip route 192.168.11.15 255.255.255.255 Tunnel1
ip route 192.168.30.30 255.255.255.255 Tunnel2
ip route 10.10.0.0 255.255.255.0 10.10.1.1
!
!-----------------------------------------
! Route Maps
!-----------------------------------------
...
neighbor 192.168.11.14 remote-as 65515
neighbor 192.168.11.14 ebgp-multihop 255
neighbor 192.168.11.14 soft-reconfiguration inbound
neighbor 192.168.11.14 update-source Loopback0
neighbor 192.168.11.14 route-map AZURE out
neighbor 192.168.11.15 remote-as 65515
neighbor 192.168.11.15 ebgp-multihop 255
neighbor 192.168.11.15 soft-reconfiguration inbound
neighbor 192.168.11.15 update-source Loopback0
neighbor 192.168.11.15 route-map AZURE out
