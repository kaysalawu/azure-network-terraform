...
conn Tunnel0
    left=10.30.1.9
    leftid=20.185.185.157
    right=4.157.239.102
    rightid=4.157.239.102
    auto=start
    mark=100
...
conn Tunnel2
    left=10.30.1.9
    leftid=20.185.185.157
    right=52.169.218.235
    rightid=52.169.218.235
    auto=start
    mark=300
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
...
10.30.1.9 4.157.239.102 : PSK "changeme"
10.30.1.9 4.157.232.199 : PSK "changeme"
10.30.1.9 52.169.218.235 : PSK "changeme"
