...
conn Tunnel0
    left=10.30.1.9
    leftid=172.191.14.7
    right=172.214.118.59
    rightid=172.214.118.59
    auto=start
    mark=100
...
conn Tunnel1
    left=10.30.1.9
    leftid=172.191.14.7
    right=172.214.118.61
    rightid=172.214.118.61
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
    left=10.30.1.9
    leftid=172.191.14.7
    right=52.169.209.102
    rightid=52.169.209.102
    auto=start
    mark=300
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
...
10.30.1.9 172.214.118.59 : PSK "changeme"
10.30.1.9 172.214.118.61 : PSK "changeme"
10.30.1.9 52.169.209.102 : PSK "changeme"
