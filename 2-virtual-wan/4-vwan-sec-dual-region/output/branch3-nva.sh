...
match address local 10.30.1.9
match identity remote address 20.67.163.55 255.255.255.255
match identity remote address 20.67.163.4 255.255.255.255
...
tunnel destination 20.67.163.55
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 20.67.163.4
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
