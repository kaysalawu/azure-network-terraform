...
peer 20.223.18.51
address 20.223.18.51
pre-shared-key changeme
peer 20.223.19.55
address 20.223.19.55
pre-shared-key changeme
peer 10.10.1.9
address 10.10.1.9
pre-shared-key changeme
...
match address local 10.30.1.9
match identity remote address 20.223.18.51 255.255.255.255
match identity remote address 20.223.19.55 255.255.255.255
...
tunnel destination 20.223.18.51
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 20.223.19.55
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
