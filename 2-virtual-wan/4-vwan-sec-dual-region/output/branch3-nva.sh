...
peer 20.82.168.93
address 20.82.168.93
pre-shared-key changeme
peer 4.231.141.230
address 4.231.141.230
pre-shared-key changeme
peer 10.10.1.9
address 10.10.1.9
pre-shared-key changeme
...
match address local 10.30.1.9
match identity remote address 20.82.168.93 255.255.255.255
match identity remote address 4.231.141.230 255.255.255.255
...
tunnel destination 20.82.168.93
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 4.231.141.230
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
