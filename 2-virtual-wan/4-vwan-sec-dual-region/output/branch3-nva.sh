...
match address local 10.30.1.9
match identity remote address 20.166.223.253 255.255.255.255
match identity remote address 4.208.16.8 255.255.255.255
...
tunnel destination 20.166.223.253
