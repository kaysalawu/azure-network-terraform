...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | vwan24-spoke3-0425-app.azurewebsites.net   |
...
| SPOKE6_APP_SVC_ENDPOINT_DNS   | vwan24-spoke6-0425-app.azurewebsites.net   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | vwan24-spoke3-0425-app.azurewebsites.net   |
| *Subnets*|        |
