...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | vwan24-spoke3-6960-app.azurewebsites.net   |
...
| SPOKE6_APP_SVC_ENDPOINT_DNS   | vwan24-spoke6-6960-app.azurewebsites.net   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | vwan24-spoke3-6960-app.azurewebsites.net   |
| *Subnets*|        |
