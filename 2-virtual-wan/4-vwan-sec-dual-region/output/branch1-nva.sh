...
match address local 10.10.1.9
match identity remote address 4.175.177.9 255.255.255.255
match identity remote address 4.175.176.250 255.255.255.255
...
tunnel destination 4.175.177.9
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.175.176.250
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
