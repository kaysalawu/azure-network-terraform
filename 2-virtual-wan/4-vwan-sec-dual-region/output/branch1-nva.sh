...
match address local 10.10.1.9
match identity remote address 20.50.17.164 255.255.255.255
match identity remote address 20.50.19.61 255.255.255.255
...
tunnel destination 20.50.17.164
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.50.19.61
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
