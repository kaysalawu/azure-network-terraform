...
match address local 10.10.1.9
match identity remote address 52.236.3.53 255.255.255.255
match identity remote address 52.236.3.45 255.255.255.255
...
tunnel destination 52.236.3.53
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 52.236.3.45
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
