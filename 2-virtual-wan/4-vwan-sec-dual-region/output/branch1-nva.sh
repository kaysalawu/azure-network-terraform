...
peer 20.93.242.189
address 20.93.242.189
pre-shared-key changeme
peer 20.93.241.212
address 20.93.241.212
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.93.242.189 255.255.255.255
match identity remote address 20.93.241.212 255.255.255.255
...
tunnel destination 20.93.242.189
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.93.241.212
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
