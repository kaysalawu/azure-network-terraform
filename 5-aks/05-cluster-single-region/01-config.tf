...
locals {
  ...
  hub1_subnets = {
    ...
    ("AksSubnet")                     = { address_prefixes = ["10.11.18.0/23", ], address_prefixes_v6 = ["fd00:db8:11:18::/64", ], }
    ("AksPodSubnet")                  = { address_prefixes = ["10.11.20.0/23", ], address_prefixes_v6 = ["fd00:db8:11:20::/64", ], }
  }
...
locals {
  ...
  hub2_subnets = {
    ...
    ("AksSubnet")                     = { address_prefixes = ["10.22.18.0/23", ], address_prefixes_v6 = ["fd00:db8:22:18::/64", ], }
    ("AksPodSubnet")                  = { address_prefixes = ["10.22.20.0/23", ], address_prefixes_v6 = ["fd00:db8:22:20::/64", ], }
  }
...
locals {
  ...
  spoke1_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.1.12.0/23", ], address_prefixes_v6 = ["fd00:db8:1:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.1.14.0/23", ], address_prefixes_v6 = ["fd00:db8:1:14::/64", ], }
  }
...
locals {
  ...
  spoke2_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.2.12.0/23", ], address_prefixes_v6 = ["fd00:db8:2:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.2.14.0/23", ], address_prefixes_v6 = ["fd00:db8:2:14::/64", ], }
  }
...
locals {
  ...
  spoke3_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.3.12.0/23", ], address_prefixes_v6 = ["fd00:db8:3:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.3.14.0/23", ], address_prefixes_v6 = ["fd00:db8:3:14::/64", ], }
  }
...
locals {
  ...
  spoke4_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.4.12.0/23", ], address_prefixes_v6 = ["fd00:db8:4:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.4.14.0/23", ], address_prefixes_v6 = ["fd00:db8:4:14::/64", ], }
  }
...
locals {
  ...
  spoke5_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.5.12.0/23", ], address_prefixes_v6 = ["fd00:db8:5:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.5.14.0/23", ], address_prefixes_v6 = ["fd00:db8:5:14::/64", ], }
  }
...
locals {
  ...
  spoke6_subnets = {
    ...
    ("AksSubnet")                = { address_prefixes = ["10.6.12.0/23", ], address_prefixes_v6 = ["fd00:db8:6:12::/64", ], }
    ("AksPodSubnet")             = { address_prefixes = ["10.6.14.0/23", ], address_prefixes_v6 = ["fd00:db8:6:14::/64", ], }
  }
