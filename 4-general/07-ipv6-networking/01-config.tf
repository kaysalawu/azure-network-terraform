...
locals {
  ...
  hub1_address_space = ["10.11.0.0/20", "10.11.16.0/20", "fd00:db8:11::/48", ]
  hub1_nat_ranges = {
    "branch1" = {
  ...
  hub1_subnets = {
    ("MainSubnet")                    = { address_prefixes = ["10.11.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:11::/64"] }
    ("UntrustSubnet")                 = { address_prefixes = ["10.11.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:1::/64"] }
    ("TrustSubnet")                   = { address_prefixes = ["10.11.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:2::/64"] }
    ("ManagementSubnet")              = { address_prefixes = ["10.11.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:3::/64"] }
    ("AppGatewaySubnet")              = { address_prefixes = ["10.11.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:4::/64"] }
    ("LoadBalancerSubnet")            = { address_prefixes = ["10.11.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:5::/64"] }
    ("PrivateLinkServiceSubnet")      = { address_prefixes = ["10.11.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:6::/64"], enable_private_link_policies = [true] }
    ("PrivateEndpointSubnet")         = { address_prefixes = ["10.11.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:7::/64"], enable_private_endpoint_policies = [true] }
    ("DnsResolverInboundSubnet")      = { address_prefixes = ["10.11.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:8::/64"], delegate = ["Microsoft.Network/dnsResolvers"] }
    ("DnsResolverOutboundSubnet")     = { address_prefixes = ["10.11.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:9::/64"], delegate = ["Microsoft.Network/dnsResolvers"] }
    ("RouteServerSubnet")             = { address_prefixes = ["10.11.10.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:a::/64"] }
    ("AzureFirewallSubnet")           = { address_prefixes = ["10.11.11.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:b::/64"] }
    ("AzureFirewallManagementSubnet") = { address_prefixes = ["10.11.12.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:c::/64"] }
    ("AppServiceSubnet")              = { address_prefixes = ["10.11.13.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:d::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")                 = { address_prefixes = ["10.11.16.0/24"], address_prefixes_ipv6 = ["fd00:db8:11:e::/64"] }
  }
...
locals {
  ...
  hub2_address_space = ["10.22.0.0/20", "10.22.16.0/20", "fd00:db8:22::/48", ]
  hub2_dns_zone      = local.region2_dns_zone
  hub2_subnets = {
    ("MainSubnet")                    = { address_prefixes = ["10.22.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:22::/64"] }
    ("UntrustSubnet")                 = { address_prefixes = ["10.22.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:1::/64"] }
    ("TrustSubnet")                   = { address_prefixes = ["10.22.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:2::/64"] }
    ("ManagementSubnet")              = { address_prefixes = ["10.22.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:3::/64"] }
    ("AppGatewaySubnet")              = { address_prefixes = ["10.22.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:4::/64"] }
    ("LoadBalancerSubnet")            = { address_prefixes = ["10.22.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:5::/64"] }
    ("PrivateLinkServiceSubnet")      = { address_prefixes = ["10.22.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:6::/64"], enable_private_link_service_network_policies = [true] }
    ("PrivateEndpointSubnet")         = { address_prefixes = ["10.22.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:7::/64"], enable_private_endpoint_network_policies = [true] }
    ("DnsResolverInboundSubnet")      = { address_prefixes = ["10.22.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:8::/64"], delegate = ["Microsoft.Network/dnsResolvers"] }
    ("DnsResolverOutboundSubnet")     = { address_prefixes = ["10.22.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:9::/64"], delegate = ["Microsoft.Network/dnsResolvers"] }
    ("RouteServerSubnet")             = { address_prefixes = ["10.22.10.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:a::/64"] }
    ("AzureFirewallSubnet")           = { address_prefixes = ["10.22.11.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:b::/64"] }
    ("AzureFirewallManagementSubnet") = { address_prefixes = ["10.22.12.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:c::/64"] }
    ("AppServiceSubnet")              = { address_prefixes = ["10.22.13.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:d::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")                 = { address_prefixes = ["10.22.16.0/24"], address_prefixes_ipv6 = ["fd00:db8:22:e::/64"] }
  }
...
locals {
  ...
  branch1_address_space = ["10.10.0.0/20", "10.10.16.0/20", "fd00:db8:10::/48", ]
  branch1_nva_asn       = "65001"
  branch1_dns_zone      = local.onprem_domain
  branch1_subnets = {
    ("MainSubnet")       = { address_prefixes = ["10.10.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:10::/64"] }
    ("UntrustSubnet")    = { address_prefixes = ["10.10.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:10:1::/64"] }
    ("TrustSubnet")      = { address_prefixes = ["10.10.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:10:2::/64"] }
    ("ManagementSubnet") = { address_prefixes = ["10.10.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:10:3::/64"] }
    ("DnsServerSubnet")  = { address_prefixes = ["10.10.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:10:4::/64"] }
    ("GatewaySubnet")    = { address_prefixes = ["10.10.16.0/24"], address_prefixes_ipv6 = ["fd00:db8:10:10::/64"] }
  }
...
locals {
  ...
  branch2_address_space = ["10.20.0.0/20", "10.20.16.0/20", "fd00:db8:20::/48", ]
  branch2_nva_asn       = "65002"
  branch2_dns_zone      = local.onprem_domain
  branch2_subnets = {
    ("MainSubnet")       = { address_prefixes = ["10.20.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:20::/64"] }
    ("UntrustSubnet")    = { address_prefixes = ["10.20.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:20:1::/64"] }
    ("TrustSubnet")      = { address_prefixes = ["10.20.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:20:2::/64"] }
    ("ManagementSubnet") = { address_prefixes = ["10.20.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:20:3::/64"] }
    ("DnsServerSubnet")  = { address_prefixes = ["10.20.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:20:4::/64"] }
    ("GatewaySubnet")    = { address_prefixes = ["10.20.16.0/24"], address_prefixes_ipv6 = ["fd00:db8:20:10::/64"] }
  }
...
locals {
  ...
  branch3_address_space = ["10.30.0.0/20", "10.30.16.0/20", "fd00:db8:0030::/48", ]
  branch3_nva_asn       = "65003"
  branch3_dns_zone      = local.onprem_domain
  branch3_subnets = {
    ("MainSubnet")       = { address_prefixes = ["10.30.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030::/64"] }
    ("UntrustSubnet")    = { address_prefixes = ["10.30.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030:1::/64"] }
    ("TrustSubnet")      = { address_prefixes = ["10.30.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030:2::/64"] }
    ("ManagementSubnet") = { address_prefixes = ["10.30.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030:3::/64"] }
    ("DnsServerSubnet")  = { address_prefixes = ["10.30.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030:4::/64"] }
    ("GatewaySubnet")    = { address_prefixes = ["10.30.16.0/24"], address_prefixes_ipv6 = ["fd00:db8:0030:10::/64"] }
  }
...
locals {
  ...
  spoke1_address_space = ["10.1.0.0/20", "fd00:db8:1::/48", ]
  spoke1_dns_zone      = local.region1_dns_zone
  spoke1_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.1.0.0/24", "fd00:db8:1::/64", ] }
    ("UntrustSubnet")            = { address_prefixes = ["10.1.1.0/24", "fd00:db8:1:1::/64", ], }
    ("TrustSubnet")              = { address_prefixes = ["10.1.2.0/24", "fd00:db8:1:2::/64", ], }
    ...
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.1.6.0/24", "fd00:db8:1:6::/64", ], }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.1.7.0/24", "fd00:db8:1:7::/64", ], }
...
locals {
  ...
  spoke2_address_space = ["10.2.0.0/20", "fd00:db8:2::/48", ]
  spoke2_dns_zone      = local.region1_dns_zone
  spoke2_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.2.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:2::/64"] }
    ("UntrustSubnet")            = { address_prefixes = ["10.2.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:1::/64"] }
    ("TrustSubnet")              = { address_prefixes = ["10.2.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:2::/64"] }
    ("ManagementSubnet")         = { address_prefixes = ["10.2.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:3::/64"] }
    ("AppGatewaySubnet")         = { address_prefixes = ["10.2.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:4::/64"] }
    ("LoadBalancerSubnet")       = { address_prefixes = ["10.2.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:5::/64"] }
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.2.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:6::/64"] }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.2.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:7::/64"] }
    ("AppServiceSubnet")         = { address_prefixes = ["10.2.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:8::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")            = { address_prefixes = ["10.2.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:2:9::/64"] }
  }
...
locals {
  ...
  spoke3_address_space = ["10.3.0.0/20", "fd00:db8:3::/48", ]
  spoke3_dns_zone      = local.region1_dns_zone
  spoke3_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.3.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:3::/64"] }
    ("UntrustSubnet")            = { address_prefixes = ["10.3.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:1::/64"] }
    ("TrustSubnet")              = { address_prefixes = ["10.3.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:2::/64"] }
    ("ManagementSubnet")         = { address_prefixes = ["10.3.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:3::/64"] }
    ("AppGatewaySubnet")         = { address_prefixes = ["10.3.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:4::/64"] }
    ("LoadBalancerSubnet")       = { address_prefixes = ["10.3.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:5::/64"] }
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.3.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:6::/64"] }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.3.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:7::/64"] }
    ("AppServiceSubnet")         = { address_prefixes = ["10.3.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:8::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")            = { address_prefixes = ["10.3.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:3:9::/64"] }
  }
...
locals {
  ...
  spoke4_address_space = ["10.4.0.0/20", "fd00:db8:4::/48", ]
  spoke4_dns_zone      = local.region2_dns_zone
  spoke4_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.4.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:4::/64"] }
    ("UntrustSubnet")            = { address_prefixes = ["10.4.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:1::/64"] }
    ("TrustSubnet")              = { address_prefixes = ["10.4.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:2::/64"] }
    ("ManagementSubnet")         = { address_prefixes = ["10.4.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:3::/64"] }
    ("AppGatewaySubnet")         = { address_prefixes = ["10.4.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:4::/64"] }
    ("LoadBalancerSubnet")       = { address_prefixes = ["10.4.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:5::/64"] }
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.4.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:6::/64"] }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.4.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:7::/64"] }
    ("AppServiceSubnet")         = { address_prefixes = ["10.4.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:8::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")            = { address_prefixes = ["10.4.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:4:9::/64"] }
  }
...
locals {
  ...
  spoke5_address_space = ["10.5.0.0/20", "fd00:db8:5::/48", ]
  spoke5_dns_zone      = local.region2_dns_zone
  spoke5_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.5.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:5::/64"] }
    ("UntrustSubnet")            = { address_prefixes = ["10.5.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:1::/64"] }
    ("TrustSubnet")              = { address_prefixes = ["10.5.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:2::/64"] }
    ("ManagementSubnet")         = { address_prefixes = ["10.5.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:3::/64"] }
    ("AppGatewaySubnet")         = { address_prefixes = ["10.5.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:4::/64"] }
    ("LoadBalancerSubnet")       = { address_prefixes = ["10.5.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:5::/64"] }
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.5.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:6::/64"] }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.5.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:7::/64"] }
    ("AppServiceSubnet")         = { address_prefixes = ["10.5.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:8::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")            = { address_prefixes = ["10.5.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:5:9::/64"] }
  }
...
locals {
  ...
  spoke6_address_space = ["10.6.0.0/20", "fd00:db8:6::/48", ]
  spoke6_dns_zone      = local.region2_dns_zone
  spoke6_subnets = {
    ("MainSubnet")               = { address_prefixes = ["10.6.0.0/24"], address_prefixes_ipv6 = ["fd00:db8:6::/64"] }
    ("UntrustSubnet")            = { address_prefixes = ["10.6.1.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:1::/64"] }
    ("TrustSubnet")              = { address_prefixes = ["10.6.2.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:2::/64"] }
    ("ManagementSubnet")         = { address_prefixes = ["10.6.3.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:3::/64"] }
    ("AppGatewaySubnet")         = { address_prefixes = ["10.6.4.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:4::/64"] }
    ("LoadBalancerSubnet")       = { address_prefixes = ["10.6.5.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:5::/64"] }
    ("PrivateLinkServiceSubnet") = { address_prefixes = ["10.6.6.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:6::/64"] }
    ("PrivateEndpointSubnet")    = { address_prefixes = ["10.6.7.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:7::/64"] }
    ("AppServiceSubnet")         = { address_prefixes = ["10.6.8.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:8::/64"], delegate = ["Microsoft.Web/serverFarms"] }
    ("GatewaySubnet")            = { address_prefixes = ["10.6.9.0/24"], address_prefixes_ipv6 = ["fd00:db8:6:9::/64"] }
  }
