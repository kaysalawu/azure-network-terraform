...
| - | -  |
| VM_IP   | 10.10.0.5   |
| VM_NAME   | G10-branch1-vm   |
| VNET_NAME   | G10-branch1-vnet   |
...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | g10-spoke3-d45e.azurewebsites.net   |
...
| VM_IP   | 10.11.0.5   |
| VM_NAME   | G10-hub1-vm   |
| VNET_NAME   | G10-hub1-vnet   |
| VNET_RANGES   | 10.11.0.0/17, 10.11.128.0/24   |
...
| - | -  |
| VM_IP   | 10.1.0.5   |
| VM_NAME   | G10-spoke1-vm   |
| VNET_NAME   | G10-spoke1-vnet   |
...
| - | -  |
| VM_IP   | 10.2.0.5   |
| VM_NAME   | G10-spoke2-vm   |
| VNET_NAME   | G10-spoke2-vnet   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | g10-spoke3-d45e.azurewebsites.net   |
| *Subnets*|        |
...
| - | -  |
| VM_IP   | 10.3.0.5   |
| VM_NAME   | G10-spoke3-vm   |
| VNET_NAME   | G10-spoke3-vnet   |
