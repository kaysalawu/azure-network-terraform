...
| - | -  |
| VM_IP   | 10.10.0.5   |
| VM_NAME   | G05-branch1-vm   |
| VNET_NAME   | G05-branch1-vnet   |
...
| - | -  |
| VM_IP   | 10.30.0.5   |
| VM_NAME   | G05-branch3-vm   |
| VNET_NAME   | G05-branch3-vnet   |
...
| SPOKE3_APP_SVC_ENDPOINT_DNS   | g05-spoke3-b0df.azurewebsites.net   |
...
| SPOKE6_APP_SVC_ENDPOINT_DNS   | g05-spoke6-b0df.azurewebsites.net   |
...
| - | -  |
| VM_IP   | 10.1.0.5   |
| VM_NAME   | G05-spoke1-vm   |
| VNET_NAME   | G05-spoke1-vnet   |
...
| - | -  |
| VM_IP   | 10.2.0.5   |
| VM_NAME   | G05-spoke2-vm   |
| VNET_NAME   | G05-spoke2-vnet   |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | g05-spoke3-b0df.azurewebsites.net   |
| *Subnets*|        |
...
| - | -  |
| VM_IP   | 10.3.0.5   |
| VM_NAME   | G05-spoke3-vm   |
| VNET_NAME   | G05-spoke3-vnet   |
...
| - | -  |
| VM_IP   | 10.4.0.5   |
| VM_NAME   | G05-spoke4-vm   |
| VNET_NAME   | G05-spoke4-vnet   |
...
| - | -  |
| VM_IP   | 10.5.0.5   |
| VM_NAME   | G05-spoke5-vm   |
| VNET_NAME   | G05-spoke5-vnet   |
...
| - | -  |
| VM_IP   | 10.6.0.5   |
| VM_NAME   | G05-spoke6-vm   |
| VNET_NAME   | G05-spoke6-vnet   |
