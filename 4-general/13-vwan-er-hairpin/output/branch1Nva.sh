...
conn Tunnel0
    left=10.10.1.9
    leftid=52.169.37.230
    right=172.205.82.253
    rightid=172.205.82.253
    auto=start
    mark=100
...
conn Tunnel1
    left=10.10.1.9
    leftid=52.169.37.230
    right=172.205.82.243
    rightid=172.205.82.243
    auto=start
    mark=101
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
...
10.10.1.9 172.205.82.253 : PSK "changeme"
10.10.1.9 172.205.82.243 : PSK "changeme"
