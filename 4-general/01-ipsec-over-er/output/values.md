...
| - | -  |
| VM_IP   | 10.10.0.5   |
| VM_NAME   | G01-branch1Vm   |
| VNET_NAME   | G01-branch1-vnet   |
...
| - | -  |
| VM_IP   | 10.20.0.5   |
| VM_NAME   | G01-branch2Vm   |
| VNET_NAME   | G01-branch2-vnet   |
...
| SPOKE3_BLOB_URL (Sample)   | https://g01spoke3saa89f.blob.core.windows.net/spoke3/spoke3.txt   |
| *Subnets*|        |
...
| - | -  |
| VM_IP   | 10.1.0.5   |
| VM_NAME   | G01-spoke1Vm   |
| VNET_NAME   | G01-spoke1-vnet   |
...
| - | -  |
| VM_IP   | 10.2.0.5   |
| VM_NAME   | G01-spoke2Vm   |
| VNET_NAME   | G01-spoke2-vnet   |
...
| - | -  |
| VM_IP   | 10.3.0.5   |
| VM_NAME   | G01-spoke3Vm   |
| VNET_NAME   | G01-spoke3-vnet   |
