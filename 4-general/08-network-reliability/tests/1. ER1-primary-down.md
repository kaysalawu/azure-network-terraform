...
Contents
- [Overview](#overview)
- [1. ER1-Primary Down](#1-er1-primary-down)
...
In this section, we'll enable only the ER1 primary connection on Megaport for 15 minutes and keep all other ER circuits shutdown. Next we'll test connectivity from `P08-Branch2Vm` to `P08-Spoke1Vm` to traverse the ER1 primary path and also observe the route tables.

<img src="../images/1-er1-primary-down.png" alt="er1-pri-enabled" width="1100">

The dashboard below shows the state of network after 15 minutes.

<img src="../images/1-er1-primary-down-dashb.png" alt="er1-pri-enabled" width="1100">
...
-------------------------------------
 ...
 1:  10.20.1.9                                             1.456ms
 2:  10.20.16.4                                            3.907ms asymm  3
 3:  172.16.0.17                                          12.364ms asymm  4
 4:  172.16.0.14                                          23.220ms asymm  5
 5:  no reply
 6:  10.11.0.5                                            25.284ms reached
...
-------------------------------------
 ...
 1:  10.20.1.9                                             1.287ms
 1:  10.20.1.9                                             1.800ms
 2:  10.20.16.4                                            2.754ms asymm  3
 3:  172.16.0.21                                          13.156ms asymm  4
 4:  172.16.0.10                                          25.303ms asymm  5
 5:  no reply
 6:  10.1.0.5                                             25.435ms reached
     Resume: pmtu 1500 hops 6 back 6
...
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.16.9                                            1.981ms asymm  2
 1:  10.11.16.9                                            2.027ms asymm  2
 2:  172.16.0.13                                          12.644ms asymm  3
 3:  172.16.0.18                                          22.094ms asymm  4
 4:  no reply
 5:  10.20.1.9                                            24.394ms
 6:  10.20.0.5                                            28.227ms reached
     Resume: pmtu 1500 hops 6 back 6

hub1
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.0.5                                             2.341ms reached
 1:  10.11.0.5                                             1.483ms reached
...
10.11.16.9   12076  10.11.16.12     8                 Connected
...
S   0.0.0.0/0 [1/0] via 10.20.1.1, eth0, 00:29:10
K>* 0.0.0.0/0 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:29:10
B>  10.1.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:29:09
  *                      via 10.20.1.1, eth0, 00:29:09
                       via 10.20.17.5 (recursive), 00:29:09
                         via 10.20.1.1, eth0, 00:29:09
B>  10.11.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:29:09
  *                       via 10.20.1.1, eth0, 00:29:09
                        via 10.20.17.5 (recursive), 00:29:09
                          via 10.20.1.1, eth0, 00:29:09
B>  10.11.16.0/20 [20/0] via 10.20.17.4 (recursive), 00:29:09
  *                        via 10.20.1.1, eth0, 00:29:09
                         via 10.20.17.5 (recursive), 00:29:09
                           via 10.20.1.1, eth0, 00:29:09
S   10.11.16.14/32 [1/0] is directly connected, vti0, 00:29:10
C>* 10.11.16.14/32 is directly connected, vti0, 00:29:10
S   10.11.16.15/32 [1/0] is directly connected, vti1, 00:29:10
C>* 10.11.16.15/32 is directly connected, vti1, 00:29:10
S>* 10.20.0.0/24 [1/0] via 10.20.1.1, eth0, 00:29:10
C>* 10.20.1.0/24 is directly connected, eth0, 00:29:10
C>* 10.20.2.0/24 is directly connected, eth1, 00:29:10
S>* 10.20.17.4/32 [1/0] via 10.20.1.1, eth0, 00:29:10
S>* 10.20.17.5/32 [1/0] via 10.20.1.1, eth0, 00:29:10
K>* 168.63.129.16/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:29:10
K>* 169.254.169.254/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:29:10
C>* 192.168.20.20/32 is directly connected, lo, 00:29:10
```
