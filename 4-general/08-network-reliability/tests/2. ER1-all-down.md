...
Contents
- [Overview](#overview)
- [1. Enable only ER1 Secondary](#1-enable-only-er1-secondary)
...
In this section, we'll enable only the ER1 secondary connection on Megaport for 15 minutes and keep all other ER circuits shutdown. Next we'll test connectivity from `P08-Branch2Vm` to `P08-Spoke1Vm` to traverse the ER1 secondary path and also observe the route tables.

<img src="../images/1-er1-secondary-enabled.png" alt="er1-sec-enabled" width="1100">

The dashboard below shows the state of network after 15 minutes.


<img src="../images/1-er1-secondary-enabled-db.png" alt="er1-sec-enabled" width="1100">

## 1. Enable only ER1 Secondary
...
-------------------------------------
 ...
 1:  10.20.1.9                                             1.585ms
 2:  10.20.16.4                                            3.330ms asymm  3
 3:  172.16.0.17                                          12.651ms asymm  4
 4:  172.16.0.14                                          23.247ms asymm  5
 5:  no reply
 6:  10.11.0.5                                            25.695ms reached
...
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.20.1.9                                             1.952ms
 2:  10.20.16.4                                            5.141ms asymm  3
 3:  172.16.0.21                                          13.023ms asymm  4
 4:  172.16.0.14                                          22.883ms asymm  5
 5:  no reply
 6:  10.1.0.5                                             25.590ms reached
     Resume: pmtu 1500 hops 6 back 6
...
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.16.6                                            1.888ms asymm  2
 1:  10.11.16.7                                            1.936ms asymm  2
 2:  172.16.0.13                                          12.465ms asymm  3
 3:  172.16.0.18                                          22.039ms asymm  4
 4:  no reply
 5:  10.20.1.9                                            23.838ms
 6:  10.20.0.5                                            24.924ms reached
     Resume: pmtu 1500 hops 6 back 6

hub1
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.0.5                                             2.268ms reached
 1:  10.11.0.5                                             2.095ms reached
     Resume: pmtu 1500 hops 1 back 1

spoke1
-------------------------------------
 1:  spoke1vm.internal.cloudapp.net                        0.061ms reached
     Resume: pmtu 65535 hops 1 back 1
...
S   0.0.0.0/0 [1/0] via 10.20.1.1, eth0, 00:43:59
K>* 0.0.0.0/0 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:43:59
B>  10.1.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:43:58
  *                      via 10.20.1.1, eth0, 00:43:58
                       via 10.20.17.5 (recursive), 00:43:58
                         via 10.20.1.1, eth0, 00:43:58
B>  10.11.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:43:58
  *                       via 10.20.1.1, eth0, 00:43:58
                        via 10.20.17.5 (recursive), 00:43:58
                          via 10.20.1.1, eth0, 00:43:58
B>  10.11.16.0/20 [20/0] via 10.20.17.4 (recursive), 00:43:58
  *                        via 10.20.1.1, eth0, 00:43:58
                         via 10.20.17.5 (recursive), 00:43:58
                           via 10.20.1.1, eth0, 00:43:58
S   10.11.16.14/32 [1/0] is directly connected, vti0, 00:43:59
C>* 10.11.16.14/32 is directly connected, vti0, 00:43:59
S   10.11.16.15/32 [1/0] is directly connected, vti1, 00:43:59
C>* 10.11.16.15/32 is directly connected, vti1, 00:43:59
S>* 10.20.0.0/24 [1/0] via 10.20.1.1, eth0, 00:43:59
C>* 10.20.1.0/24 is directly connected, eth0, 00:43:59
C>* 10.20.2.0/24 is directly connected, eth1, 00:43:59
S>* 10.20.17.4/32 [1/0] via 10.20.1.1, eth0, 00:43:59
S>* 10.20.17.5/32 [1/0] via 10.20.1.1, eth0, 00:43:59
K>* 168.63.129.16/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:43:59
K>* 169.254.169.254/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 00:43:59
C>* 192.168.20.20/32 is directly connected, lo, 00:43:59
```
...
You have successfully tested the ER1 secondary path. Next, we'll test the ER2 primary path.
