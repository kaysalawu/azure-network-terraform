...
The dashboard marker shows that the primary and secondary links of ExpressRoute circuits `Poc08-er1` and `Poc08-er2` are up. The ExpressRoute gateway `Poc08-hub1-ergw` is zone-redundant and has two instances of the gateway in different availability zones. The dashboard shows active traffic flow across the two instances.
...
-------------------------------------
 ...
 1:  10.20.1.9                                             1.763ms
 2:  10.20.16.4                                            3.418ms asymm  3
 3:  172.16.0.17                                          12.821ms asymm  4
 4:  172.16.0.6                                           23.102ms asymm  5
 5:  no reply
 6:  10.11.0.5                                            26.366ms reached
...
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.20.1.9                                             1.301ms
 2:  10.20.16.4                                            8.248ms asymm  3
 3:  172.16.0.21                                          12.486ms asymm  4
 4:  172.16.0.2                                           24.778ms asymm  5
 5:  no reply
 6:  10.1.0.5                                             25.862ms reached
     Resume: pmtu 1500 hops 6 back 6
...
We can see that we are ECMP load balancing traffic across two MSEE paths - **172.16.0.4/30** (for `Poc08-hub1Vm`)  and **172.16.0.0/30** (for `Poc08-spoke1Vm`). Trace path shows asymmetrical routing for both paths. This is the normal behaviour for traffic over ExpressRoute circuits - as inbound traffic goes via the ExpressRoute gateway and outbound traffic goes directly to the ExpressRoute circuit on the MSEE.
...
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.16.9                                            1.979ms asymm  2
 1:  10.11.16.6                                            2.703ms asymm  2
 2:  172.16.0.5                                           11.857ms asymm  3
 3:  172.16.0.18                                          22.633ms asymm  4
 4:  no reply
 5:  10.20.1.9                                            24.914ms
 6:  10.20.0.5                                            25.545ms reached
     Resume: pmtu 1500 hops 6 back 6

hub1
-------------------------------------
 1?: [LOCALHOST]                      pmtu 1500
 1:  10.11.0.5                                             5.614ms reached
 1:  10.11.0.5                                             2.044ms reached
     Resume: pmtu 1500 hops 1 back 1

spoke1
-------------------------------------
 1:  spoke1vm.internal.cloudapp.net                        0.090ms reached
     Resume: pmtu 65535 hops 1 back 1
...
10.20.17.4  65515  10.20.16.13     6                 Connected
10.20.17.5  65515  10.20.16.13     6                 Connected
...
172.16.0.20/30  10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.20/30  10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
172.16.0.12/30  10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.12/30  10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
172.16.0.4/30   10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.4/30   10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
172.16.0.16/30  10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.16/30  10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
172.16.0.8/30   10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.8/30   10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
172.16.0.0/30   10.20.16.4  IBgp      10.20.17.4    12076-64512        32768
172.16.0.0/30   10.20.16.4  IBgp      10.20.17.5    12076-64512        32768
...
The network virtual appliance (NVA) is the next hop for all traffic to destination `10.0.0.0/8`; which includes our test vitual machines - `Poc08-hub1Vm1` and `Poc08-spoke1Vm`. Once th etraffic reaches the NVA, it will follow the BGP route towards ExpressRoute because it has a higher local preference than BGP routes received over the IPsec tunnels. The NVA will forward the traffic through its default gateway (on the untrusted network) interface (NIC) towards the virtual network (VNet).
...
The on-premises network (Megaport MCR) learns all Azure prefixes **10.11.0.0/20** and **10.1.0.0/20** via the ExpressRoute circuits.
...
S   0.0.0.0/0 [1/0] via 10.20.1.1, eth0, 2d10h46m
K>* 0.0.0.0/0 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 2d10h46m
B>  10.1.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:09:00
  *                      via 10.20.1.1, eth0, 00:09:00
                       via 10.20.17.5 (recursive), 00:09:00
                         via 10.20.1.1, eth0, 00:09:00
B>  10.11.0.0/20 [20/0] via 10.20.17.4 (recursive), 00:09:00
  *                       via 10.20.1.1, eth0, 00:09:00
                        via 10.20.17.5 (recursive), 00:09:00
                          via 10.20.1.1, eth0, 00:09:00
B>  10.11.16.0/20 [20/0] via 10.20.17.4 (recursive), 00:09:00
  *                        via 10.20.1.1, eth0, 00:09:00
                         via 10.20.17.5 (recursive), 00:09:00
                           via 10.20.1.1, eth0, 00:09:00
S   10.11.16.14/32 [1/0] is directly connected, vti0, 00:32:07
C>* 10.11.16.14/32 is directly connected, vti0, 00:32:07
S   10.11.16.15/32 [1/0] is directly connected, vti1, 00:25:10
C>* 10.11.16.15/32 is directly connected, vti1, 00:25:10
S>* 10.20.0.0/24 [1/0] via 10.20.1.1, eth0, 2d10h46m
C>* 10.20.1.0/24 is directly connected, eth0, 2d10h46m
C>* 10.20.2.0/24 is directly connected, eth1, 2d10h46m
S>* 10.20.17.4/32 [1/0] via 10.20.1.1, eth0, 2d10h46m
S>* 10.20.17.5/32 [1/0] via 10.20.1.1, eth0, 2d10h46m
K>* 168.63.129.16/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 2d10h46m
K>* 169.254.169.254/32 [0/100] via 10.20.1.1, eth0, src 10.20.1.9, 2d10h46m
C>* 192.168.20.20/32 is directly connected, lo, 2d10h46m
```
