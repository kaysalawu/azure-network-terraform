...
locals {
  ...
  vm_script_targets_region1 = [
    ...
    { name = "spoke2-nm ", dns = local.spoke2_vm_fqdn, ip = local.spoke2_vm_addr, ping = false, curl = false, probe = true, port = 22 },
    { name = "spoke2-nm ", dns = local.spoke2_vm_fqdn, ip = local.spoke2_vm_addr, ping = false, curl = false, probe = true, port = 3389 },
