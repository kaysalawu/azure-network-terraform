...
locals {
  ...
  spoke1_be1_addr    = cidrhost(local.spoke1_subnets["MainSubnet"].address_prefixes[0], 6)
  spoke1_be2_addr    = cidrhost(local.spoke1_subnets["MainSubnet"].address_prefixes[0], 7)
