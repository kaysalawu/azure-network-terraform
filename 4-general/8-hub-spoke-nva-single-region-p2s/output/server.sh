...
echo  "\$(timeout 4 curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ge08-spoke3-8fbb.azurewebsites.net) - ge08-spoke3-8fbb.azurewebsites.net"
EOF
