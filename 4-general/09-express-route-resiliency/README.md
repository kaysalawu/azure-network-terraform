...
**4.1** Login to on-premises virtual machine `Lab09-branch2Nva` via the [serial console](https://learn.microsoft.com/en-us/troubleshoot/azure/virtual-machines/serial-console-overview#access-serial-console-for-virtual-machines-via-azure-portal):
  - username = ***azureuser***
  - password = ***Password123***
...
```sh
bash ../../scripts/_cleanup.sh Lab09_ExR_VPN_RG
```
...
```sh
08-network-paths-er-vpn$ bash ../../scripts/_cleanup.sh Lab09_ExR_VPN_RG

Resource group: Lab09_ExR_VPN_RG

⏳ Checking for diagnostic settings on resources in Lab09_ExR_VPN_RG ...
➜  Checking firewall ...
➜  Checking vnet gateway ...
    ...
    ❌ Deleting: diag setting [Lab09-hub1-vpngw-diag] for vnet gateway [Lab09-hub1-vpngw] ...
➜  Checking vpn gateway ...
➜  Checking er gateway ...
➜  Checking app gateway ...
⏳ Checking for azure policies in Lab09_ExR_VPN_RG ...
Done!
```
...
```sh
bash ../../scripts/express-route/delete_ergw_connections.sh Lab09_ExR_VPN_RG
bash ../../scripts/express-route/delete_private_peerings.sh Lab09_ExR_VPN_RG
bash ../../scripts/express-route/delete_er_circuits.sh Lab09_ExR_VPN_RG
...
```sh
08-network-paths-er-vpn$ bash ../../scripts/express-route/delete_ergw_connections.sh Lab09_ExR_VPN_RG
...
```sh
08-network-paths-er-vpn$ bash ../../scripts/express-route/delete_er_circuits.sh Lab09_ExR_VPN_RG
...
```sh
az group delete -g Lab09_ExR_VPN_RG --no-wait
```
