...
```sh
hs13-spoke3-05e9.azurewebsites.net
```
...
hs13-spoke3-05e9.azurewebsites.net  canonical name = hs13-spoke3-05e9-app.privatelink.azurewebsites.net.
...
3-hub-spoke-nva-single-region$ curl $spoke3_apps_url
{
  "Headers": {
    ...
    "Disguised-Host": "hs13-spoke3-05e9.azurewebsites.net",
    "Host": "hs13-spoke3-05e9.azurewebsites.net",
    "Max-Forwards": "10",
    "User-Agent": "curl/7.74.0",
    "Was-Default-Hostname": "hs13-spoke3-05e9.azurewebsites.net",
...
**6.1** Recall the hostname of the app service in ***spoke3*** as done in *Step 5.2*. In this lab deployment, the hostname is `hs13-spoke3-05e9.azurewebsites.net`.
...
**6.3.** Resolve the hostname DNS - which is `hs13-spoke3-05e9.azurewebsites.net` in this example. Use your actual hostname from *Step 6.1*.
...
```sh
azureuser@Hs13-branch1-vm:~$ nslookup hs13-spoke3-05e9.azurewebsites.net
Server:         127.0.0.53
...
- On-premises server `Hs13-branch1-vm` makes a DNS request for `hs13-spoke3-05e9.azurewebsites.net`
- The request is received by on-premises DNS server `Hs13-branch1-dns`
- The DNS server resolves `hs13-spoke3-05e9.azurewebsites.net` to the CNAME `hs13-spoke3-05e9-app.privatelink.azurewebsites.net`
...
```sh
azureuser@Hs13-branch1-vm:~$ curl hs13-spoke3-05e9.azurewebsites.net
{
  "Headers": {
    "Accept": "*/*",
