...
output "private_ip0" {
  value = try(azurerm_virtual_network_gateway.this.bgp_settings[0].peering_addresses[0].tunnel_ip_addresses[1], null)
}

output "private_ip1" {
  value = try(azurerm_virtual_network_gateway.this.bgp_settings[0].peering_addresses[1].tunnel_ip_addresses[1], null)
}
