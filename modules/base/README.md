...
| <a name="input_config_nva"></a> [config\_nva](#input\_config\_nva) | n/a | <pre>object({<br>    enable          = optional(bool, false)<br>    type            = optional(string, "cisco")<br>    ilb_untrust_ip  = optional(string)<br>    ilb_trust_ip    = optional(string)<br>    custom_data     = optional(string)<br>    scenario_option = optional(string, "TwoNics") # Active-Active, TwoNics<br>    opn_type        = optional(string, "TwoNics") # Primary, Secondary, TwoNics<br>  })</pre> | <pre>{<br>  "custom_data": null,<br>  "enable": false,<br>  "internal_lb_addr": null,<br>  "type": "cisco"<br>}</pre> | no |
