...
peer 20.93.254.101
address 20.93.254.101
pre-shared-key changeme
peer 20.93.254.71
address 20.93.254.71
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.93.254.101 255.255.255.255
match identity remote address 20.93.254.71 255.255.255.255
...
tunnel destination 20.93.254.101
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.93.254.71
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
