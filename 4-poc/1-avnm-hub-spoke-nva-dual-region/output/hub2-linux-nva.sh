...
echo -e "\n ping dns ...\n"
echo "vm.branch1.co.net - \$(dig +short vm.branch1.co.net | tail -n1) -\$(ping -qc2 -W1 vm.branch1.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.hub1.cloud.co.net - \$(dig +short vm.hub1.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.hub1.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.spoke1.cloud.co.net - \$(dig +short vm.spoke1.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.spoke1.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.spoke2.cloud.co.net - \$(dig +short vm.spoke2.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.spoke2.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.branch3.co.net - \$(dig +short vm.branch3.co.net | tail -n1) -\$(ping -qc2 -W1 vm.branch3.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.hub2.cloud.co.net - \$(dig +short vm.hub2.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.hub2.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.spoke4.cloud.co.net - \$(dig +short vm.spoke4.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.spoke4.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
echo "vm.spoke5.cloud.co.net - \$(dig +short vm.spoke5.cloud.co.net | tail -n1) -\$(ping -qc2 -W1 vm.spoke5.cloud.co.net 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "\$5" ms":"NA") }')"
...
echo -e "\n curl dns ...\n"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.branch1.co.net) - vm.branch1.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.hub1.cloud.co.net) - vm.hub1.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke3.p.hub1.cloud.co.net) - spoke3.p.hub1.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke1.cloud.co.net) - vm.spoke1.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke2.cloud.co.net) - vm.spoke2.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke3.cloud.co.net) - vm.spoke3.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.branch3.co.net) - vm.branch3.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.hub2.cloud.co.net) - vm.hub2.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null spoke6.p.hub2.cloud.co.net) - spoke6.p.hub2.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke4.cloud.co.net) - vm.spoke4.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke5.cloud.co.net) - vm.spoke5.cloud.co.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null vm.spoke6.cloud.co.net) - vm.spoke6.cloud.co.net"
