...
peer 20.123.121.74
address 20.123.121.74
pre-shared-key changeme
peer 20.123.120.82
address 20.123.120.82
pre-shared-key changeme
peer 10.10.1.9
address 10.10.1.9
pre-shared-key changeme
...
match address local 10.30.1.9
match identity remote address 20.123.121.74 255.255.255.255
match identity remote address 20.123.120.82 255.255.255.255
...
tunnel destination 20.123.121.74
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 20.123.120.82
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
neighbor 192.168.10.10 route-map NEXT-HOP out
