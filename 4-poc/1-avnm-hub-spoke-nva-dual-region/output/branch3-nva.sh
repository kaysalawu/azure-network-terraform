...
peer 51.104.177.82
address 51.104.177.82
pre-shared-key changeme
peer 51.104.177.9
address 51.104.177.9
pre-shared-key changeme
peer 10.10.1.9
address 10.10.1.9
pre-shared-key changeme
...
match address local 10.30.1.9
match identity remote address 51.104.177.82 255.255.255.255
match identity remote address 51.104.177.9 255.255.255.255
...
tunnel destination 51.104.177.82
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 51.104.177.9
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip route 53.200.231.4 255.255.255.255 Tunnel0
ip route 53.200.231.5 255.255.255.255 Tunnel1
...
neighbor 53.200.231.4 remote-as 65515
neighbor 53.200.231.4 ebgp-multihop 255
neighbor 53.200.231.4 soft-reconfiguration inbound
neighbor 53.200.231.4 update-source Loopback0
neighbor 53.200.231.4 route-map AZURE out
neighbor 53.200.231.5 remote-as 65515
neighbor 53.200.231.5 ebgp-multihop 255
neighbor 53.200.231.5 soft-reconfiguration inbound
neighbor 53.200.231.5 update-source Loopback0
neighbor 53.200.231.5 route-map AZURE out
