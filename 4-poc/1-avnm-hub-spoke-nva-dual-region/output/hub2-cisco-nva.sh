...
match address local 53.200.225.9
!
...
!
interface Loopback0
ip address 53.200.22.22 255.255.255.255
interface Loopback1
ip address 53.200.226.99 255.255.255.255
!
!
ip route 0.0.0.0 0.0.0.0 53.200.225.1
!
route-map NEXT-HOP permit 100
match ip address prefix-list all
set ip next-hop 53.200.226.99
!
router bgp 65000
bgp router-id 53.200.225.9
