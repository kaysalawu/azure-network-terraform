...
10.11.1.4 10.22.1.4 : PSK "changeme"
...
case "$PLUTO_CONNECTION" in
  vti_hub2)
    ...
    VTI_LOCALADDR=10.10.10.17
    VTI_REMOTEADDR=10.10.10.18
    ;;
esac
...
! Static Routes
!-----------------------------------------
ip route 10.11.10.4/32 10.11.1.1
ip route 10.11.10.5/32 10.11.1.1
ip route 10.22.1.4/32 10.11.1.1
