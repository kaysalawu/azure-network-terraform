...
| - | -  |
| VM_IP   | 10.10.0.5   |
| VM_NAME   | Hs15-branch1Vm   |
| VNET_NAME   | Hs15-branch1-vnet   |
...
| - | -  |
| VM_IP   | 10.30.0.5   |
| VM_NAME   | Hs15-branch3Vm   |
| VNET_NAME   | Hs15-branch3-vnet   |
...
| SPOKE3_BLOB_URL (Sample)   | https://hs15spoke3saf34e.blob.core.windows.net/spoke3/spoke3.txt   |
| *Subnets*|        |
...
| SPOKE6_BLOB_URL (Sample)   | https://hs15spoke6saf34e.blob.core.windows.net/spoke6/spoke6.txt   |
| *Subnets*|        |
...
| - | -  |
| VM_IP   | 10.1.0.5   |
| VM_NAME   | Hs15-spoke1Vm   |
| VNET_NAME   | Hs15-spoke1-vnet   |
...
| - | -  |
| VM_IP   | 10.2.0.5   |
| VM_NAME   | Hs15-spoke2Vm   |
| VNET_NAME   | Hs15-spoke2-vnet   |
...
| - | -  |
| VM_IP   | 10.3.0.5   |
| VM_NAME   | Hs15-spoke3Vm   |
| VNET_NAME   | Hs15-spoke3-vnet   |
...
| - | -  |
| VM_IP   | 10.4.0.5   |
| VM_NAME   | Hs15-spoke4Vm   |
| VNET_NAME   | Hs15-spoke4-vnet   |
...
| - | -  |
| VM_IP   | 10.5.0.5   |
| VM_NAME   | Hs15-spoke5Vm   |
| VNET_NAME   | Hs15-spoke5-vnet   |
...
| - | -  |
| VM_IP   | 10.6.0.5   |
| VM_NAME   | Hs15-spoke6Vm   |
| VNET_NAME   | Hs15-spoke6-vnet   |
