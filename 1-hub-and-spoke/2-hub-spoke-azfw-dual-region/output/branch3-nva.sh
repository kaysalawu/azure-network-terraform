...
match address local 10.30.1.9
match identity remote address 20.191.55.140 255.255.255.255
match identity remote address 20.54.39.3 255.255.255.255
...
tunnel destination 20.191.55.140
