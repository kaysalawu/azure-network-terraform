...
conn Tunnel0
    left=10.10.1.9
    leftid=52.138.193.29
    right=68.219.14.151
    rightid=68.219.14.151
    auto=start
    mark=100
...
10.10.1.9 68.219.14.151 : PSK "changeme"
10.10.1.9 68.219.14.97 : PSK "changeme"
10.10.1.9 40.71.191.53 : PSK "changeme"
