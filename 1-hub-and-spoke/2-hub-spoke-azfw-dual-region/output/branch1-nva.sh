...
match address local 10.10.1.9
match identity remote address 20.76.4.174 255.255.255.255
match identity remote address 20.76.3.200 255.255.255.255
...
tunnel destination 20.76.4.174
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.76.3.200
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
