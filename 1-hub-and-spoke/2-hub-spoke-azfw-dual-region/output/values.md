...
|--------|--------|
| DNS_IN_IP   | 10.11.5.4   |
| SPOKE3_APP_SVC_ENDPOINT_DNS   | hs12-spoke3-2ba4-app.azurewebsites.net   |
...
|--------|--------|
| DNS_IN_IP   | 10.22.5.4   |
| SPOKE6_APP_SVC_ENDPOINT_DNS   | hs12-spoke6-37af-app.azurewebsites.net   |
| SPOKE6_APP_SVC_ENDPOINT_IP   | 10.22.4.5   |
| SPOKE6_WEB_APP_ENDPOINT_DNS   | spoke6.p   |
| SPOKE6_WEB_APP_ENDPOINT_IP   | 10.11.4.4   |
| *Subnets*|        |
...
| Item    | Value  |
|--------|--------|
| APPS_URL   | hs12-spoke3-2ba4-app.azurewebsites.net   |
| *Subnets*|        |
