  ...
  output_values = templatefile("../../scripts/outputs/values.md", {
    NODES = {
      ...
      hub2 = {
        ...
        SUBNETS                          = try({ for k, v in module.hub2.subnets : k => join(", ", v.address_prefixes) }, "")
      }
      spoke1 = {
      ...
      spoke4 = {
        ...
        SUBNETS     = try({ for k, v in module.spoke4.subnets : k => join(", ", v.address_prefixes) }, "")
      }
      spoke5 = {
        ...
        SUBNETS     = try({ for k, v in module.spoke5.subnets : k => join(", ", v.address_prefixes) }, "")
      }
      spoke6 = {
        ...
        SUBNETS     = try({ for k, v in module.spoke6.subnets : k => join(", ", v.address_prefixes) }, "")
      }
      branch1 = {
      ...
      branch3 = {
        ...
        SUBNETS     = try({ for k, v in module.branch3.subnets : k => join(", ", v.address_prefixes) }, "")
      }
    }
  })
}
