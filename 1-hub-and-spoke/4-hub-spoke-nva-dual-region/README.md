...
branch1 - 10.10.0.5 -OK 8.652 ms
hub1    - 10.11.0.5 -OK 4.418 ms
spoke1  - 10.1.0.5 -OK 0.047 ms
spoke2  - 10.2.0.5 -OK 4.792 ms
branch3 - 10.30.0.5 -OK 25.098 ms
hub2    - 10.22.0.5 -OK 25.800 ms
spoke4  - 10.4.0.5 -OK 20.723 ms
spoke5  - 10.5.0.5 -OK 21.090 ms
internet - icanhazip.com -OK 5.221 ms
```
...
vm.branch1.corp - 10.10.0.5 -OK 9.271 ms
vm.hub1.az.corp - 10.11.0.5 -OK 5.462 ms
vm.spoke1.az.corp - 10.1.0.5 -OK 0.038 ms
vm.spoke2.az.corp - 10.2.0.5 -OK 4.829 ms
vm.branch3.corp - 10.30.0.5 -OK 25.291 ms
vm.hub2.az.corp - 10.22.0.5 -OK 20.291 ms
vm.spoke4.az.corp - 10.4.0.5 -OK 20.573 ms
vm.spoke5.az.corp - 10.5.0.5 -OK 21.089 ms
icanhazip.com - 104.18.115.97 -OK 5.385 ms
```
...
200 (0.040372s) - 10.10.0.5 - vm.branch1.corp
200 (0.027068s) - 10.11.0.5 - vm.hub1.az.corp
200 (0.019401s) - 10.11.4.4 - spoke3.p.hub1.az.corp
[16232.962061] cloud-init[1638]: 10.1.0.5 - - [05/Nov/2023 17:24:30] "GET / HTTP/1.1" 200 -
200 (0.019922s) - 10.1.0.5 - vm.spoke1.az.corp
200 (0.039997s) - 10.2.0.5 - vm.spoke2.az.corp
000 (2.001709s) -  - vm.spoke3.az.corp
200 (0.091390s) - 10.30.0.5 - vm.branch3.corp
200 (0.064534s) - 10.22.0.5 - vm.hub2.az.corp
200 (0.064507s) - 10.22.4.4 - spoke6.p.hub2.az.corp
200 (0.084942s) - 10.4.0.5 - vm.spoke4.az.corp
200 (0.105349s) - 10.5.0.5 - vm.spoke5.az.corp
000 (2.001411s) -  - vm.spoke6.az.corp
200 (0.018242s) - 104.18.114.97 - icanhazip.com
```
...
```sh
hs14-spoke3-7184-app.azurewebsites.net
```
...
hs14-spoke3-7184-app.azurewebsites.net  canonical name = hs14-spoke3-7184-app.privatelink.azurewebsites.net.
hs14-spoke3-7184-app.privatelink.azurewebsites.net      canonical name = waws-prod-am2-651.sip.azurewebsites.windows.net.
waws-prod-am2-651.sip.azurewebsites.windows.net canonical name = waws-prod-am2-651-4b1f.westeurope.cloudapp.azure.com.
Name:   waws-prod-am2-651-4b1f.westeurope.cloudapp.azure.com
Address: 20.105.232.25
```

We can see that the endpoint is a public IP address, ***20.105.232.25***. We can see the CNAME `hs14-spoke3-7184-app.privatelink.azurewebsites.net` created for the app service which recursively resolves to the public IP address.
...
4-hub-spoke-nva-dual-region$ curl $spoke3_apps_url
{
  "Headers": {
    "Accept": "*/*",
    "Client-Ip": "174.173.70.196:55294",
    "Disguised-Host": "hs14-spoke3-7184-app.azurewebsites.net",
    "Host": "hs14-spoke3-7184-app.azurewebsites.net",
    "Max-Forwards": "10",
    "User-Agent": "curl/7.74.0",
    "Was-Default-Hostname": "hs14-spoke3-7184-app.azurewebsites.net",
    "X-Arr-Log-Id": "4f805e82-f945-41d3-9538-abd321e596f1",
    "X-Client-Ip": "174.173.70.196",
    "X-Client-Port": "55294",
    "X-Forwarded-For": "174.173.70.196:55294",
    "X-Original-Url": "/",
    "X-Site-Deployment-Id": "hs14-spoke3-7184-app",
    "X-Waws-Unencoded-Url": "/"
  },
  "Hostname": "5fc99e471d87",
...
6.3. Resolve the hostname DNS - which is `hs14-spoke3-7184-app.azurewebsites.net` in this example. Use your actual hostname from Step 6.1
```sh
...
Sample output
```sh
azureuser@Hs14-branch1-vm:~$ nslookup hs14-spoke3-7184-app.azurewebsites.net
Server:         127.0.0.53
Address:        127.0.0.53#53

Non-authoritative answer:
hs14-spoke3-7184-app.azurewebsites.net  canonical name = hs14-spoke3-7184-app.privatelink.azurewebsites.net.
Name:   hs14-spoke3-7184-app.privatelink.azurewebsites.net
Address: 10.11.4.5
```
...
- On-premises server `Hs14-branch1-vm` makes a DNS request for `hs14-spoke3-7184-app.azurewebsites.net`
- The request is received by on-premises DNS server `Hs14-branch1-dns`
- The DNS server resolves `hs14-spoke3-7184-app.azurewebsites.net` to the CNAME `hs14-spoke3-7184-app.privatelink.azurewebsites.net`
...
Sample output
```sh
azureuser@Hs14-branch1-vm:~$ curl hs14-spoke3-7184-app.azurewebsites.net
{
  "Headers": {
    "Accept": "*/*",
    "Client-Ip": "[fd40:ca16:112:e8d2:7c12:100:a0a:5]:46040",
    "Disguised-Host": "hs14-spoke3-7184-app.azurewebsites.net",
    "Host": "hs14-spoke3-7184-app.azurewebsites.net",
    "Max-Forwards": "10",
    "User-Agent": "curl/7.68.0",
    "Was-Default-Hostname": "hs14-spoke3-7184-app.azurewebsites.net",
    "X-Arr-Log-Id": "b748cf82-6992-45f7-9b7e-5881f091ca9a",
...
1. Run the `trace-ip` script
   ...
   branch1
   -------------------------------------
    1:  Hs14-branch1-vm                                       0.072ms reached
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             1.557ms
    1:  10.10.2.9                                             0.798ms
    2:  10.10.2.9                                             2.054ms pmtu 1438
    2:  10.11.1.4                                             4.985ms
    3:  10.11.0.5                                             6.581ms reached
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             1.767ms
    1:  10.10.2.9                                             1.051ms
    2:  10.10.2.9                                             1.220ms pmtu 1438
    2:  10.11.1.4                                             7.257ms
    3:  10.1.0.5                                              6.697ms reached
        Resume: pmtu 1438 hops 3 back 3
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             2.818ms
    1:  10.10.2.9                                             1.939ms
    2:  10.10.2.9                                             2.648ms pmtu 1438
    2:  10.11.1.4                                             5.164ms
    3:  10.2.0.5                                              6.713ms reached
        Resume: pmtu 1438 hops 3 back 3
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             2.361ms
    1:  10.10.2.9                                             1.424ms
    2:  10.10.2.9                                             1.000ms pmtu 1446
    2:  10.30.30.9                                           20.415ms
    3:  10.30.30.9                                           28.268ms pmtu 1438
    3:  10.22.1.4                                            22.802ms
    4:  10.22.0.5                                            23.305ms reached
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             1.306ms
    1:  10.10.2.9                                             0.992ms
    2:  10.10.2.9                                             1.618ms pmtu 1446
    2:  10.30.30.9                                           19.585ms
    3:  10.30.30.9                                           19.144ms pmtu 1438
    3:  10.22.1.4                                            21.605ms
    4:  10.4.0.5                                             22.213ms reached
        Resume: pmtu 1438 hops 4 back 4
   ...
   -------------------------------------
    ...
    1:  10.10.2.9                                             1.300ms
    1:  10.10.2.9                                             2.014ms
    2:  10.10.2.9                                             1.593ms pmtu 1446
    2:  10.30.30.9                                           19.018ms
    3:  10.30.30.9                                           25.039ms pmtu 1438
    3:  10.22.1.4                                            21.699ms
    4:  10.5.0.5                                             22.399ms reached
        Resume: pmtu 1438 hops 4 back 4
...
We can observe that traffic to ***spoke1***, ***spoke2*** and ***hub1*** flow symmetrivcally via the NVA in ***hub1*** (10.11.1.4). However, traffic to ***spoke4***, ***spoke5*** and ***hub2*** flow asymmetrically via the NVA in ***hub2*** (10.22.1.4).

### 8. Onprem Routes

Login to the onprem router `Hs14-branch1-nva` in order to observe its dynamic routes.

1. Login to virtual machine `Hs14-branch1-nva` via the [serial console](https://learn.microsoft.com/en-us/troubleshoot/azure/virtual-machines/serial-console-overview#access-serial-console-for-virtual-machines-via-azure-portal).
...
B        10.1.0.0/16 [20/0] via 10.11.7.4, 04:32:42
B        10.2.0.0/16 [20/0] via 10.11.7.4, 04:32:42
B        10.4.0.0/16 [20/0] via 192.168.30.30, 04:32:42
B        10.5.0.0/16 [20/0] via 192.168.30.30, 04:32:42
...
B        10.11.0.0/16 [20/0] via 10.11.7.4, 04:32:42
S        10.11.7.4/32 is directly connected, Tunnel1
S        10.11.7.5/32 is directly connected, Tunnel0
B        10.22.0.0/16 [20/0] via 192.168.30.30, 04:32:42
B        10.30.0.0/24 [20/0] via 192.168.30.30, 04:32:42
