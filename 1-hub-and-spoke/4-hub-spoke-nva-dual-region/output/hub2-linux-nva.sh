...
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null hs14-spoke3-5271.azurewebsites.net) - hs14-spoke3-5271.azurewebsites.net"
echo  "\$(curl -kL --max-time 2.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null hs14-spoke6-5271.azurewebsites.net) - hs14-spoke6-5271.azurewebsites.net"
EOF
