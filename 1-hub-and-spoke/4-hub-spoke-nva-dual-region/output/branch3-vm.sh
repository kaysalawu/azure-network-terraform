...
nping -c 10 --tcp -p 80 hs14-spoke3-9e99.azurewebsites.net > /dev/null 2>&1
nping -c 10 --tcp -p 80 hs14-spoke6-9e99.azurewebsites.net > /dev/null 2>&1
EOF
...
while [ \$i -lt 8 ]; do
    ...
    ab -n \$1 -c \$2 hs14-spoke3-9e99.azurewebsites.net > /dev/null 2>&1
    ab -n \$1 -c \$2 hs14-spoke6-9e99.azurewebsites.net > /dev/null 2>&1
    let i=i+1
  sleep 5
done
EOF
