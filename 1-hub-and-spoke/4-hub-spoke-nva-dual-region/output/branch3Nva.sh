...
conn Tunnel0
    left=10.30.1.9
    leftid=52.168.49.49
    right=172.171.135.94
    rightid=172.171.135.94
    auto=start
    mark=100
...
conn Tunnel1
    left=10.30.1.9
    leftid=52.168.49.49
    right=172.171.135.109
    rightid=172.171.135.109
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
    left=10.30.1.9
    leftid=52.168.49.49
    right=52.178.161.217
    rightid=52.178.161.217
    auto=start
    mark=300
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
...
10.30.1.9 172.171.135.94 : PSK "changeme"
10.30.1.9 172.171.135.109 : PSK "changeme"
10.30.1.9 52.178.161.217 : PSK "changeme"
