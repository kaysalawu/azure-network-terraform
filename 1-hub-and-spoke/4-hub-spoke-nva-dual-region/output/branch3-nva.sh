...
match address local 10.30.1.9
match identity remote address 4.207.66.89 255.255.255.255
match identity remote address 4.207.66.123 255.255.255.255
...
tunnel destination 4.207.66.89
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 4.207.66.123
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
