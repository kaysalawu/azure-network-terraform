...
match address local 10.10.1.9
match identity remote address 20.166.137.207 255.255.255.255
match identity remote address 4.207.194.1 255.255.255.255
...
tunnel destination 20.166.137.207
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.207.194.1
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
