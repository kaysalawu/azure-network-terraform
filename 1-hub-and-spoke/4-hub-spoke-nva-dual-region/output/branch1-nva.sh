...
peer 20.242.186.26
address 20.242.186.26
pre-shared-key changeme
peer 20.242.186.71
address 20.242.186.71
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.242.186.26 255.255.255.255
match identity remote address 20.242.186.71 255.255.255.255
...
tunnel destination 20.242.186.26
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.242.186.71
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
