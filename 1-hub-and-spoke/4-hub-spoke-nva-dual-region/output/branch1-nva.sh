...
peer 20.4.242.155
address 20.4.242.155
pre-shared-key changeme
peer 20.4.241.169
address 20.4.241.169
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.4.242.155 255.255.255.255
match identity remote address 20.4.241.169 255.255.255.255
...
tunnel destination 20.4.242.155
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.4.241.169
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
