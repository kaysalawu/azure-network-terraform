...
conn Tunnel0
    left=10.10.1.9
    leftid=13.74.118.159
    right=172.205.36.251
    rightid=172.205.36.251
    auto=start
    mark=100
...
10.10.1.9 172.205.36.251 : PSK "changeme"
10.10.1.9 172.205.37.4 : PSK "changeme"
