...
conn Tunnel0
    left=10.10.1.9
    leftid=52.178.222.21
    right=40.127.252.140
    rightid=40.127.252.140
    auto=start
    mark=100
...
conn Tunnel1
    left=10.10.1.9
    leftid=52.178.222.21
    right=40.127.252.147
    rightid=40.127.252.147
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
...
10.10.1.9 40.127.252.140 : PSK "changeme"
10.10.1.9 40.127.252.147 : PSK "changeme"
