...
peer 20.31.215.43
address 20.31.215.43
pre-shared-key changeme
peer 20.31.215.246
address 20.31.215.246
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.31.215.43 255.255.255.255
match identity remote address 20.31.215.246 255.255.255.255
...
tunnel destination 20.31.215.43
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.31.215.246
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip route 10.11.10.13 255.255.255.255 Tunnel0
ip route 10.11.10.12 255.255.255.255 Tunnel1
...
neighbor 10.11.10.13 remote-as 65515
neighbor 10.11.10.13 ebgp-multihop 255
neighbor 10.11.10.13 soft-reconfiguration inbound
neighbor 10.11.10.13 update-source Loopback0
neighbor 10.11.10.13 route-map AZURE out
neighbor 10.11.10.12 remote-as 65515
neighbor 10.11.10.12 ebgp-multihop 255
neighbor 10.11.10.12 soft-reconfiguration inbound
neighbor 10.11.10.12 update-source Loopback0
neighbor 10.11.10.12 route-map AZURE out
