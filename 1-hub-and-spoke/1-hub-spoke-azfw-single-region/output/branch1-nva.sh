...
peer 20.103.231.19
address 20.103.231.19
pre-shared-key changeme
peer 20.23.192.131
address 20.23.192.131
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.103.231.19 255.255.255.255
match identity remote address 20.23.192.131 255.255.255.255
...
tunnel destination 20.103.231.19
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.23.192.131
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
