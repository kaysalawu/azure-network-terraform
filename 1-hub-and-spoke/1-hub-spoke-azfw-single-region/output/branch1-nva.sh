...
match address local 10.10.1.9
match identity remote address 4.175.64.128 255.255.255.255
match identity remote address 4.175.64.87 255.255.255.255
...
tunnel destination 4.175.64.128
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 4.175.64.87
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
