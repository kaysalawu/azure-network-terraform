...
peer 20.223.103.122
address 20.223.103.122
pre-shared-key changeme
peer 20.223.103.135
address 20.223.103.135
pre-shared-key changeme
peer 10.30.1.9
address 10.30.1.9
pre-shared-key changeme
...
match address local 10.10.1.9
match identity remote address 20.223.103.122 255.255.255.255
match identity remote address 20.223.103.135 255.255.255.255
...
tunnel destination 20.223.103.122
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.223.103.135
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip route 10.11.16.6 255.255.255.255 Tunnel0
ip route 10.11.16.7 255.255.255.255 Tunnel1
