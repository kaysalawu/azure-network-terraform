...
conn Tunnel0
    left=10.10.1.9
    leftid=52.169.113.129
    right=135.236.129.6
    rightid=135.236.129.6
    auto=start
    mark=100
...
conn Tunnel1
    left=10.10.1.9
    leftid=52.169.113.129
    right=135.236.129.14
    rightid=135.236.129.14
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
...
10.10.1.9 135.236.129.6 : PSK "changeme"
10.10.1.9 135.236.129.14 : PSK "changeme"
