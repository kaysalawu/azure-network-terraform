...
conn Tunnel0
    left=10.10.1.9
    leftid=40.113.10.40
    right=172.205.93.211
    rightid=172.205.93.211
    auto=start
    mark=100
...
conn Tunnel1
    left=10.10.1.9
    leftid=40.113.10.40
    right=172.205.93.209
    rightid=172.205.93.209
    auto=start
    mark=200
    leftupdown="/etc/ipsec.d/ipsec-vti.sh"
conn Tunnel2
...
10.10.1.9 172.205.93.211 : PSK "changeme"
10.10.1.9 172.205.93.209 : PSK "changeme"
