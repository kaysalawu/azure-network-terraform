...
locals {
  #azure_lb_frontend_ipv4 = "elb-${local.hub1_appgw_pip}.nip.io"
}

output "test" {
  value = module.azure_lb_dual_stack.public_ip_addresses
}
