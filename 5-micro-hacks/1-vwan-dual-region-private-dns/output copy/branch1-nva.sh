...
peer 20.246.214.70
address 20.246.214.70
pre-shared-key changeme
peer 20.246.213.253
address 20.246.213.253
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.246.214.70 255.255.255.255
match identity remote address 20.246.213.253 255.255.255.255
...
tunnel destination 20.246.214.70
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.246.213.253
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
