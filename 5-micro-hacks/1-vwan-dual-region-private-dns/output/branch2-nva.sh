...
peer 52.191.233.135
address 52.191.233.135
pre-shared-key changeme
peer 52.191.233.112
address 52.191.233.112
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.20.1.9
match identity remote address 52.191.233.135 255.255.255.255
match identity remote address 52.191.233.112 255.255.255.255
...
tunnel destination 52.191.233.135
...
ip tcp adjust-mss 1350
tunnel source 10.20.1.9
tunnel destination 52.191.233.112
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
