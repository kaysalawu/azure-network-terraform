...
peer 20.237.70.221
address 20.237.70.221
pre-shared-key changeme
peer 20.246.193.27
address 20.246.193.27
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.20.1.9
match identity remote address 20.237.70.221 255.255.255.255
match identity remote address 20.246.193.27 255.255.255.255
...
tunnel destination 20.237.70.221
...
ip tcp adjust-mss 1350
tunnel source 10.20.1.9
tunnel destination 20.246.193.27
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
