...
locals {
  ...
  region1_code     = "eu"
  region2_code     = "us"
  region1_dns_zone = "${local.region2_code}.${local.cloud_domain}"
...
locals {
  ...
  branch1_vm_hostname        = "vm.branch1"
...
locals {
  ...
  branch2_vm_hostname        = "vm.branch2"
...
locals {
  ...
  branch3_vm_hostname        = "vm.branch3"
