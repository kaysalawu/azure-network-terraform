  ...
  output_values = templatefile("../../scripts/outputs/values.md", {
    NODES = {
      hub1 = {
        ...
        ENDPOINT_SPOKE3 = try(azurerm_private_endpoint.hub1_spoke3_pls_pep.private_service_connection[0].private_ip_address, "")
      ...
      hub2 = {
        ...
        ENDPOINT_SPOKE6 = try(azurerm_private_endpoint.hub1_spoke3_pls_pep.private_service_connection[0].private_ip_address, "")
